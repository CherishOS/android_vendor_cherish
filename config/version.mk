...
CHERISH_VERSION := $(CHERISH_VERSION)-$(CHERISH_BUILD)-$(CHERISH_BUILD_DATE)-$(CHERISH_BUILD_TYPE)
CHERISH_MOD_VERSION :=$(ANDROID_VERSION)-$(CHERISH_VERSION)
CHERISH_DISPLAY_VERSION := CHERISHOS-$(CHERISH_VERSION)-$(CHERISH_BUILD_TYPE)
